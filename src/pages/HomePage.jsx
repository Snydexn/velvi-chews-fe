        ...
        <section className="mt-8 flex flex-col items-center gap-4 max-w-lg mx-auto">
          ...
          <div className="w-full text-center">
            ...
            <p className="text-xs text-[#FCAFC1] mb-1">
              ...
              Velvi Chews menghadirkan opsi snack atau dessert yang lebih sehat
              untuk kamu yang tetap ingin ngemil yang manis namun tidak mau
              meresikokan kesehatan.
            </p>
          </div>
          {/* Gambar Produk (Lebih Kecil & Rata Tengah) */}
          <div className="w-4/5 mx-auto">
            {" "}
            {/* Mengurangi lebar menjadi w-4/5 dan menambahkan mx-auto */}
            <img
        ...
        <section className="relative mt-2 w-screen">
          ...
          <div className="relative z-10 py-16 px-6">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm text-white">
              ...
              untuk kesehatan kulit, rambut, sendi, dan tulang; serta madu asli
              yang baik untuk imunitas dan pencernaan menjadikan produk homemade
              gummy Velvi Chews sebagai pilihan yang cocok sebagai pengganti
              permen untuk kamu konsumsi.
            </p>
          </div>
        </section>
        ...
        <div className="w-full max-w-md">
          <section className="mt-5 mb-5">
            ...
            <p className="mt-2 text-xs text-[#FCAFC1]">
              ...
              sayur tanpa gula maupun pengawet untuk kesehatan yang lebih baik.
            </p>
          </section>
        </div>
        ...
        <div className="relative mt-10 w-screen">
          ...
          <div className="relative z-10 mx-auto max-w-md">
            ...
            <section className="mt-10 mb-20">
              ...
              <p className="mt-2 text-xs text-white">
                Velvi Chews akan berusaha semampu kami untuk selalu bertanggung
                jawab dengan produksi kami. Maka dari itu, kami menggunakan
                biodegradable packaging yang bisa terurai sendiri di alam dalam
                waktu 2 tahun.
              </p>
            </section>
          </div>
